...
cat system/system/app/OCRDataProvider/OCRDataProvider.apk.* 2>/dev/null >> system/system/app/OCRDataProvider/OCRDataProvider.apk
rm -f system/system/app/OCRDataProvider/OCRDataProvider.apk.* 2>/dev/null
cat system/system/app/KTCustomerService/KTCustomerService.apk.* 2>/dev/null >> system/system/app/KTCustomerService/KTCustomerService.apk
rm -f system/system/app/KTCustomerService/KTCustomerService.apk.* 2>/dev/null
cat system/system/app/KTAuth/KTAuth.apk.* 2>/dev/null >> system/system/app/KTAuth/KTAuth.apk
rm -f system/system/app/KTAuth/KTAuth.apk.* 2>/dev/null
...
cat system/system/priv-app/TalkbackSE/TalkbackSE.apk.* 2>/dev/null >> system/system/priv-app/TalkbackSE/TalkbackSE.apk
rm -f system/system/priv-app/TalkbackSE/TalkbackSE.apk.* 2>/dev/null
cat system/system/priv-app/TPhoneOnePackage/TPhoneOnePackage.apk.* 2>/dev/null >> system/system/priv-app/TPhoneOnePackage/TPhoneOnePackage.apk
rm -f system/system/priv-app/TPhoneOnePackage/TPhoneOnePackage.apk.* 2>/dev/null
